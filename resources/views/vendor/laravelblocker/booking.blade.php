												...
												<div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
													...
													<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active py-3" href="apps/calendar.html">
																	<span class="menu-icon">
					...
					<div class="toolbar py-3 py-lg-6" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
							...
							<div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
								<!--begin::Title-->
								<h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">Calendar</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
							...
							<div class="d-flex align-items-center">
								...
								<a href="#" class="btn btn-flex bg-body h-35px h-lg-40px px-5" id="kt_dashboard_daterangepicker" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-trigger="hover" title="Select dashboard daterange">
									<span class="me-4">
										...
										<span class="text-primary fw-bold" id="kt_dashboard_daterangepicker_date">Aug 12</span>
									</span>
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
								...
								<div class="card-header">
									<h2 class="card-title fw-bold">Apponitment Calendar</h2>
									<div class="card-toolbar">
										<button class="btn btn-flex btn-primary" data-kt-calendar="add">
										<i class="ki-duotone ki-plus fs-2"></i>Book Appointment</button>
									</div>
								</div>
								<!--end::Card header-->
								<!--begin::Card body-->
									...
									<div class="modal-content">
										...
										<form class="form" action="#" id="kt_modal_add_event_form">
											...
											<div class="modal-header">
												<!--begin::Modal title-->
												<h2 class="fw-bold" data-kt-calendar="title">Book Appointment</h2>
												<!--end::Modal title-->
												<!--begin::Close-->
											...
											<div class="modal-body py-10 px-lg-17">
												...
												<div class="fv-row mb-9">
													<!--begin::Label-->
													<label class="fs-6 fw-semibold required mb-2">Patient Name</label>
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" class="form-control form-control-solid" placeholder="" name="patient" />
													<!--end::Input-->
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
												<div class="fv-row mb-9">
													<!--begin::Label-->
													<label class="fs-6 fw-semibold required mb-2">Doctor Name</label>
													<!--end::Label-->
													<!--begin::Input-->
													<select class="form-select form-select-solid" placeholder="" name="doctor">
														<option value=""></option>
												...
												<div class="fv-row mb-9">
													<!--begin::Label-->
													<label class="fs-6 fw-semibold mb-2">Appointment Description</label>
													<!--end::Label-->
													<!--begin::Input-->
												...
												<div class="row row-cols-lg-2 g-10">
													<div class="col">
														<div class="fv-row mb-9">
															<!--begin::Label-->
															<label class="fs-6 fw-semibold mb-2 required">Appointment Date</label>
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" name="date" placeholder="Pick a date" id="kt_calendar_datepicker_start_date" />
															<!--end::Input-->
														</div>
													</div>
													<div class="col" data-kt-calendar="datepicker">
														<div class="fv-row mb-9">
															<!--begin::Label-->
															<label class="fs-6 fw-semibold mb-2">Appointment Time</label>
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" name="time" placeholder="Pick a time" id="kt_calendar_datepicker_start_time" />
															<!--end::Input-->
														</div>
													</div>
												</div>
