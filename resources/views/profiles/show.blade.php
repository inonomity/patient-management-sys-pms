...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comaccount/overview.html" />
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<!--begin::Username-->
													<div class="d-flex flex-column">
														<div class="fw-bold d-flex align-items-center fs-5"> {{ trans('profile.showProfileTitle',['username' => $user->name]) }}
									...
									<div class="d-flex flex-wrap flex-sm-nowrap">
										...
										<div class="flex-grow-1">
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<!--end::User-->
                                                <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
														<a href="{{ url('/booking') }}" class="d-flex align-items-center btn btn-primary  me-5 mb-2">
														Bookings</a>
												...
												<div class="d-flex flex-column flex-grow-1 pe-8">
													...
													<div class="d-flex flex-wrap">
														...
														<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
															...
															<!--end::Number-->
															<!--begin::Label-->
															<div class="fw-semibold fs-6 text-gray-500">Billed Amount</div>
															<!--end::Label-->
														</div>
														<!--end::Stat-->
														<!--begin::Stat-->
							...
							<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
								...
								<div class="card-body p-9">
                                    ...
                                    @if ($user->email && ($currentUser->id == $user->id || $currentUser->hasRole('admin')))
                                        <div class="row mb-7">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 fw-semibold text-muted">{{ trans('profile.showProfileEmail') }}</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8">
                                    ...
                                    @if ($user->profile)
                                        @if ($user->profile->theme_id && ($currentUser->id == $user->id || $currentUser->hasRole('admin')))
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">{{ trans('profile.showProfileTheme') }}</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800">{{ $currentTheme->name }} </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                        @endif
